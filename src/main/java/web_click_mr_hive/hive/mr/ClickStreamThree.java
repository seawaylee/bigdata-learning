...
public class ClickStreamThree
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        FileInputFormat.setInputPaths(job, new Path("/Users/lixiwei-mac/Documents/IdeaProjects/bigdatalearning/src/data/web_click/pre/output/part-m-00000"));
        FileOutputFormat.setOutputPath(job, new Path("/Users/lixiwei-mac/Documents/IdeaProjects/bigdatalearning/src/data/web_click/page_view/output"));
